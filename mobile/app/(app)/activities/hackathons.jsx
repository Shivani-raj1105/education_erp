    ...
    <SafeAreaView style={styles.safe} edges={['bottom']}>
      <ScrollView style={styles.scroll} contentContainerStyle={styles.content}>
        ...
        <View style={styles.card}>
          <Text style={styles.bodyText}>This module connects to the backend activities endpoint for hackathon records and can be expanded with create, edit, and delete actions.</Text>
        </View>
      </ScrollView>
    </SafeAreaView>
  );
