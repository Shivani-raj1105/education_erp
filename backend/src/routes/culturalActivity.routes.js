...
const { getList, getById, create, update, remove } = require('../controllers/culturalActivity.controller');
...
// GET /api/activities/cultural
router.get('/', getList);

// GET /api/activities/cultural/:id
router.get('/:id', getById);

// POST /api/activities/cultural  (HOD only)
router.post('/', requireHOD, createValidation, validate, create);

// PUT /api/activities/cultural/:id  (HOD only)
router.put('/:id', requireHOD, updateValidation, validate, update);

// DELETE /api/activities/cultural/:id  (HOD only)
